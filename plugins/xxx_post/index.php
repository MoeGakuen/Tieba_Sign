            ...
            <form method="post" id="xxx_post_settings" action="plugin.php?id=xxx_post&action=set-settings" onsubmit="return post_win(this.action, this.id)">
                <p>客户端类型：
                    <select name="x_p_client_type" id="x_p_client_type" disabled>
                        ...
                        <option value="5">随机选择一种（不推荐）</option>
                    </select>
                </p>
                <p>回帖频率：
            ...
            <table class="x_table">
                <thead>
                    <tr>
                        ...
                        <td>贴吧</td>
                        <td>贴子</td>
                        <td style="width: 20px">成功</td>
                        <td style="width: 20px">失败</td>
                    </tr>
                </thead>
                <tbody id="x_p_log_tab">
                    <tr><td colspan="5">载入中请稍后</td></tr>
                </tbody>
            </table>
        </div>
        <div>
